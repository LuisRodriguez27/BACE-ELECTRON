...
import { captureBudgetHtmlAsPng, prepareBudgetHtml } from '../utils/buildBudgetPageHtml';
...
export function useWhatsAppBudget() {
  ...
  const startWhatsAppFlow = (budgetData: Budget) => {
    setMessageText('Le enviamos la cotización solicitada esperamos vernos favorecidos, será un placer colaborar con usted');
  ...
  const confirmAndSend = async () => {
    ...
    try {
      ...
      if (copied) {
        ...
        anchor.href = url;
        anchor.download = `presupuesto-${budgetData.id}.png`;
        anchor.click();
    ...
    >
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg mx-4">
        ...
        <p className="text-sm text-gray-500 mb-4">
          Edita el mensaje que se enviará al cliente con su presupuesto.
        </p>
        <textarea
