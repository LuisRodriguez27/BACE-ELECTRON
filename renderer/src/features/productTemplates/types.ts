...
export const createProductTemplateSchema = z.object({
  ...
  width: z.number().min(0, 'El ancho debe ser un número positivo').optional().or(z.nan().transform(() => undefined)),
  height: z.number().min(0, 'El alto debe ser un número positivo').optional().or(z.nan().transform(() => undefined)),
